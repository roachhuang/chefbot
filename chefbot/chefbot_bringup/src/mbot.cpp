// #include <ros/ros.h>
// h/w interface
#include <chefbot_bringup/mbot.h>
...
MyRobot::MyRobot(ros::NodeHandle &nh) : nh_(nh)
{
	...
	/*
	hardware_interface::JointHandle pos_handle_a(jnt_state_interface.getHandle("right_wheel_joint"), &cmd[0]);
	jnt_pos_interface.registerHandle(pos_handle_a);
	hardware_interface::JointHandle pos_handle_b(jnt_state_interface.getHandle("left_wheel_joint"), &cmd[1]);
	...
	*/
	...
	hardware_interface::JointHandle effort_handle_a(jnt_state_interface.getHandle("right_wheel_joint"), &cmd[0]);
...
void MyRobot::write(ros::Time time, ros::Duration period)
{
	...
	// cmd[0] is registered as right joint
